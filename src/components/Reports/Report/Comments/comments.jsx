...
import { addComment, deleteComment } from "../../../../Store/Slices/reportSlice";
import { useDispatch } from "react-redux";
import { formatTimestamp } from "../../../../main";

function Comments({ report, timeStamp, theme }) {
    ...
    return(
        <div className="report-comments-container" style={{ background: theme.primary_color, color: theme.font_color, border: `2px solid ${theme.border}` }} >
            <div className="report-comments-title">Comments</div>
            <div className="report-comments-input-container">
                <input type="text" className="report-comments-input" value={comment} placeholder="Enter comment..." onChange={handleInputChange} style={{ background: theme.background_color, color: theme.font_color }} />
                <button className="report-comments-button" onClick={handleSaveComment} style={{ background: theme.primary_color, color: theme.font_color, border: `2px solid ${theme.border}` }} >+</button>
            </div>
