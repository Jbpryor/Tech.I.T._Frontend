...
function SideBar() {
  ...
  return (
    <section className={`sideBar ${demoUser === 'admin' || demoUser === 'manager' ? 'grid-1' : 'grid-2'}`} style={{ background: theme.primary_color, color: theme.font_color, border: `1px solid ${theme.border}` }}>
