...
function Reports() {
    ...
    return (
        <>
            {viewMode === 'list' ? (
                <section className="reports reports-list">
                                ...
                                <table>
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th value='subject' className={`subject-column ${subjectColumnActive ? 'active' : ''}`} onClick={() => handleActiveColumn('subject')}>Subject <i className={`bx bx-down-arrow ${subjectRotate ? 'rotate' : ''} ${subjectColumnActive ? 'active' : ''}`} onClick={() => handleActiveColumn('subject')}></i></th>
                                            <th value='project' className={`project-column ${projectColumnActive ? 'active' : ''}`} onClick={() => handleActiveColumn('project')}>Project <i className={`bx bx-down-arrow ${projectRotate ? 'rotate' : ''} ${projectColumnActive ? 'active' : ''}`} onClick={() => handleActiveColumn('project')}></i></th>
                                            {isReportsActive && <th value='description' className={`description-column ${descriptionColumnActive ? 'active' : ''}`} onClick={() => handleActiveColumn('description')}>Description <i className={`bx bx-down-arrow ${descriptionRotate ? 'rotate' : ''} ${descriptionColumnActive ? 'active' : ''}`} onClick={() => handleActiveColumn('description')}></i></th>}
                                            {isReportsActive && <th value='submitter' className={`submitter-column ${submitterColumnActive ? 'active' : ''}`} onClick={() => handleActiveColumn('submitter')}>Submitter <i className={`bx bx-down-arrow ${submitterRotate ? 'rotate' : ''} ${submitterColumnActive ? 'active' : ''}`} onClick={() => handleActiveColumn('submitter')}></i></th>}
                                            {isReportsActive && <th value='created' className={`created-column ${createdColumnActive ? 'active' : ''}`} onClick={() => handleActiveColumn('created')}>Created <i className={`bx bx-down-arrow ${createdRotate ? 'rotate' : ''} ${createdColumnActive ? 'active' : ''}`} onClick={() => handleActiveColumn('created')}></i></th>}
                                        </tr>
