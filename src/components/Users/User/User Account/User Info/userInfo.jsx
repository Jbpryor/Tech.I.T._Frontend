        ...
        <div className="user-info-container" style={{ background: theme.primary_color, border: `2px solid ${theme.border}` }} >
            <div className="user-full-name-container">
                ...
                <div className="user-email-content">
                    ...
                    {editMode ? (
                        <input className="user-email input" type='email' value={email} onChange={(event) => setEmail(event.target.value)} style={{ background: theme.background_color, color: theme.font_color, border: `1px solid ${theme.border}` }} />
                    ) : (
            ...
            <div className="address-container">
                <div className="address-content">
                    ...
                    {editMode ? (
                        <input className="user-address input" type="text" value={street} onChange={(event) => setStreet(event.target.value)} style={{ background: theme.background_color, color: theme.font_color, border: `1px solid ${theme.border}` }} />
                    ) : (
            ...
            <div className="city-state-container">
                <div className="city-content">
                    ...
                    {editMode ? (
                        <input className="user-city input" type="text" value={city} onChange={(event) => setCity(event.target.value)} style={{ background: theme.background_color, color: theme.font_color, border: `1px solid ${theme.border}` }} />
                    ): (
                ...
                <div className="state-content">
                    ...
                    {editMode ? (
                        <input className="user-state input" type="text" value={state} onChange={(event) => setState(event.target.value)} style={{ background: theme.background_color, color: theme.font_color, border: `1px solid ${theme.border}` }} />
                    ): (
            ...
            <div className="zip-country-container">
                <div className="zip-content">
                    ...
                    {editMode ? (
                        <input className="user-zip input" type="text" value={zip} onChange={(event) => setZip(event.target.value)} style={{ background: theme.background_color, color: theme.font_color, border: `1px solid ${theme.border}` }}  />
                    ) : (
                ...
                <div className="country-content">
                    ...
                    {editMode ? (
                        <select className="use-country input" id="country" name="address.country" value={country} onChange={(event) => setCountry(event.target.value)} style={{ background: theme.background_color, border: `1px solid ${theme.border}`, color: theme.font_color }} ><CountryMenu /></select>
                    ) : (
